...
export class AppComponent {
  ...
  constructor(
    ...
    this.matIconRegistry.addSvgIconLiteral(
      'github',
      this.sanitizer.bypassSecurityTrustHtml(this.githubSvgIcon)
    );
  }
